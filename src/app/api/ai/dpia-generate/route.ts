...
3. Κίνδυνοι GDPR για αυτό το έργο — 5-6 κίνδυνοι συγκεκριμένοι για το project (σύντομη πρόταση ο καθένας).
4. Μέτρα μείωσης κινδύνου — ένα μέτρο για κάθε κίνδυνο, ίδια σειρά, σύντομη πρόταση.
