      ...
      <div className="min-w-0 flex-1">
        {articleHtml ? (
          <article className="rounded-lg border border-neutral-200 bg-white p-6 shadow-sm sm:p-8">
            ...
            <div
              className="wiki-content max-w-none text-[15px] leading-7 text-neutral-700 [&_a]:text-[#0078d4] [&_a]:underline [&_blockquote]:border-l-4 [&_blockquote]:border-neutral-200 [&_blockquote]:pl-4 [&_blockquote]:text-neutral-500 [&_code]:rounded [&_code]:bg-neutral-100 [&_code]:px-1 [&_h2]:mb-2 [&_h2]:mt-6 [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:text-neutral-900 [&_h3]:mb-1 [&_h3]:mt-5 [&_h3]:text-base [&_h3]:font-semibold [&_h3]:text-neutral-800 [&_img]:my-4 [&_img]:rounded-md [&_img]:border [&_img]:border-neutral-200 [&_li]:my-1 [&_ol]:my-3 [&_ol]:list-decimal [&_ol]:pl-6 [&_p]:my-3 [&_strong]:text-neutral-900 [&_table]:my-4 [&_table]:w-full [&_td]:border [&_td]:border-neutral-200 [&_td]:p-2 [&_th]:border [&_th]:border-neutral-200 [&_th]:bg-neutral-50 [&_th]:p-2 [&_ul]:my-3 [&_ul]:list-disc [&_ul]:pl-6 [&_img]:max-w-full [&_img]:shadow-sm [&_figure]:my-5 [&_figcaption]:mt-1.5 [&_figcaption]:text-center [&_figcaption]:text-xs [&_figcaption]:text-neutral-400 [&_.wiki-note]:my-4 [&_.wiki-note]:rounded-md [&_.wiki-note]:border [&_.wiki-note]:border-amber-200 [&_.wiki-note]:bg-amber-50 [&_.wiki-note]:px-3 [&_.wiki-note]:py-2 [&_.wiki-note]:text-sm [&_.wiki-note]:text-amber-700"
